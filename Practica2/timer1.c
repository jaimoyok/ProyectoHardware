...
void temporizador1_empezar(void) { timer1_int_count = 0; }

// devuelve el valor actual del contador principal
unsigned int temporizador1_leer(void) { return timer1_int_count; };
